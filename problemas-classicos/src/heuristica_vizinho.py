...
def max_independent_set(graph):
    ...
    #Obtém uma lista de vértices ordenada por grau em ordem crescente
    ...
    for vertex in sorted_vertices:
        #Verifica se o vértice pode ser adicionado ao conjunto independente
        if vertex not in removed_vertices:
            #Adiciona o vértice ao conjunto independente
            independent_set.add(vertex)
            #Remove o vértice e seus vizinhos do grafo
...
def plot_graph(graph, independent_set):
    ...
    #Destaca o conjunto independente de verde
